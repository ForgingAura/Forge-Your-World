...
import forgingaura.forgeyourworld.ffactory.Container.ContainerIronFurnace;
...
public class TileEntityIronFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.ironfurnace";
    }
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty())
            {
                ...
                if (this.isBurning() && this.canSmelt())
                {
                    ...
                    {
                        this.cookTime = 0;
                        this.totalCookTime = (int)(this.getCookTime(this.furnaceItemStacks.get(0)) / 1.5);
                        this.smeltItem();
                        flag1 = true;
                    }
                }
    ...
    {
        return new ContainerIronFurnace(playerInventory, this);
    }
