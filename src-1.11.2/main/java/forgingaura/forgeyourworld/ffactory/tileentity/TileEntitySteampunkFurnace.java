package forgingaura.forgeyourworld.ffactory.tileentity;
...
public class TileEntitySteampunkFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.steampunkfurnace";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntitySteampunkFurnace.class, new String[] {"Items"}));
    }
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty())
            {
                ...
                if (this.isBurning() && this.canSmelt())
                {
                    ...
                    {
                        this.cookTime = 0;
                        this.totalCookTime = (int)(this.getCookTime(this.furnaceItemStacks.get(0)) / 2);
                        this.smeltItem();
                        flag1 = true;
                    }
                }
            ...
            {
                flag1 = true;
                SteampunkFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    public static int getItemBurnTime(ItemStack stack)
    {
        ...
        {
            //int burnTime = net.minecraftforge.event.ForgeEventFactory.getItemBurnTime(stack); 1.12
    ...
    {
        return new ContainerSteampunkFurnace(playerInventory, this);
    }
