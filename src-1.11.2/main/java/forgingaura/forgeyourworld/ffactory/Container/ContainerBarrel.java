    ...
    public void detectAndSendChanges()
    {
        ...
        for(int i = 0; i < this.listeners.size(); ++i)
        {
            ...
            */
            ...
            if(this.cookTime != this.tileentity.getField(2)) listener.sendProgressBarUpdate(this, 2, this.tileentity.getField(2));
            if(this.burnTime != this.tileentity.getField(0)) listener.sendProgressBarUpdate(this, 0, this.tileentity.getField(0));
            if(this.currentBurnTime != this.tileentity.getField(1)) listener.sendProgressBarUpdate(this, 1, this.tileentity.getField(1));
            if(this.totalCookTime != this.tileentity.getField(3)) listener.sendProgressBarUpdate(this, 3, this.tileentity.getField(3));
        }
