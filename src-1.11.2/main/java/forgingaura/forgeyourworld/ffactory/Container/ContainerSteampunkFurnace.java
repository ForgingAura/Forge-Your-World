...
public class ContainerSteampunkFurnace extends Container {
    ...
    public ContainerSteampunkFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (index != 1 && index != 0)
            {
                ...
                else if (TileEntitySteampunkFurnace.isItemFuel(itemstack1))
                {
