...
public class IronFurnace extends BlockContainer {
    ...
    public IronFurnace(boolean isBurning){
        super(Material.ROCK);
    ...
    {
        return Item.getItemFromBlock(FactoryBlock.ironfurnace);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, FactoryBlock.litironfurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, FactoryBlock.litironfurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, FactoryBlock.ironfurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, FactoryBlock.ironfurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new ItemStack(FactoryBlock.ironfurnace);
    }
