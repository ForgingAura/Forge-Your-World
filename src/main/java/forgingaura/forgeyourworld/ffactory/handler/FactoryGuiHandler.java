...
{/*
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        {
            return new ContainerSteampunkFurnace((TileEntitySteampunkFurnace)tile, player.inventory);
        }
        return null;
    }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        if(tile instanceof TileEntitySteampunkFurnace)
        {
            return new GuiSteampunkFurnace((TileEntitySteampunkFurnace)tile, player.inventory);
        }
        return null;
    }*/
}