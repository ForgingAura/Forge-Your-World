...
public class TileEntityBarrel extends TileEntity implements IInventory, ITickable {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                Barrel.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt() {
        if (((ItemStack) this.inventory.get(0)).isEmpty() || ((ItemStack) this.inventory.get(1)).isEmpty())
            ...
            ItemStack result = BarrelRecipeHandler.getInstance().getDecomposerResult((ItemStack) this.inventory.get(0), (ItemStack) this.inventory.get(1));
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            ItemStack result = BarrelRecipeHandler.getInstance().getDecomposerResult(input1, input2);
            ItemStack output = (ItemStack) this.inventory.get(3);
    ...
    public static int getItemBurnTime(ItemStack fuel) {
        if (fuel.isEmpty()) return 0;
            ...
            if (item == Items.WATER_BUCKET) return 200;
            return 0;
        }
    }
